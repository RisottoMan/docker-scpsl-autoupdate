...
if [ -z "${AUTO_UPDATE}" ] || [ "${AUTO_UPDATE}" == "1" ]; then
    ...
    if [ "${BRANCH_TAG}" == "" ]; then
        ...
        ./DepotDownloader -app 996560 -depot 996562 -dir /home/container -validate
    else
        echo "Using branch: ${BRANCH_TAG}"
        ./DepotDownloader -app 996560 -depot 996562 -branch "${BRANCH_TAG}" -dir /home/container -validate
    fi
